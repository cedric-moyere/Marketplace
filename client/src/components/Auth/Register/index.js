  ...
  isVisible && (
    <div className="alert alert-info mt-3">
      <p className="icontext">
        <i className="icon text-primary fa fa-thumbs-up"></i>User successfully created
      </p>
    </div>
  );
...
const Register = ({ history }) => {
  ...
  const { first, last, email, city, country, gender, password, confirm_password } =
    formValues["register"] ?? {};
      ...
      <div className="card mx-auto" style={{ maxWidth: "520px", marginTop: "140px" }}>
        <article className="card-body">
          ...
          <form name="register" onSubmit={handleOnSubmit}>
            ...
            <div className="form-group">
              <Input.Checkbox name="terms" col="6" onChange={handleOnChange}>
                I agree with <a href="#">terms and contitions</a>
              </Input.Checkbox>
            </div>
          </form>
        </article>
